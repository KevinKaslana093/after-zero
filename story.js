(function () {
  ...
  addChain('intro', ch0, 'rooftop', [
    ...
    ['旁白', '我拖着行李站在旧广播大楼天台。录用邮件后还附着一段修复录音，发送时间显示为八年前。'],
    ['江朔的录音', '“江临，如果你听见这段话，不要来找我。”', null],
    ['旁白', '八年前，哥哥失踪前给我打过最后一通电话。那天我们刚吵完架，我没有接。如今他的声音却把我带回了他消失前工作过的地方。'],
    ['？？？', '“{hero}？”', 'lincheng'],
    ...
    ['失真男声', '“原来这一次……还有人在听。”', null],
    ['旁白', '我回头。雨幕里没有人。只有关闭的手机屏幕映出林澄、我，以及一个不属于天台任何位置的模糊视线。', null]
  ], 'studio_01');
  ...
  addChain('onair', ch1, 'studio', [
    ...
    ['唐砂', '“她夸人了。{hero}，你值得把今天写进日记。”', 'tangsha'],
    ['林澄', '“唐砂，闭麦。”', 'lincheng'],
